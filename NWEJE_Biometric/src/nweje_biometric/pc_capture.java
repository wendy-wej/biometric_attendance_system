 ...
 */
public class pc_capture extends javax.swing.JFrame {

    /**
     * Creates new form pc_capture
     */
    
    static {
        File file = new File("C:\\Users\\Chinwendu Nweje\\Documents\\NetBeansProjects\\Class Example Image\\src\\required\\opencv_java249.dll");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (option == 0) {
            try {
                ...
                pc_work_page.jTextField1.setText(Filename);
    ...
    private void CaptureImage(JLabel image) {
        try {
            ...
            if (getImage != null) {
                ...
                ImageIcon imageico = new ImageIcon(new ImageIcon(Filename).getImage().getScaledInstance(pc_work_page.jLabel3.getWidth(), pc_work_page.jLabel3.getHeight(), Image.SCALE_DEFAULT));
                pc_work_page.jLabel3.setIcon(imageico);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(rootPane, "Warning");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pc_capture.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pc_capture().setVisible(true);
            }
        });
    }
